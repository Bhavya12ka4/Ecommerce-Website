...
import FrontPageBasic from "./FrontPageBasic.jsx";
...
function Homepage() {
  ...
  return (
    <>
      ...
      <div className="h-[1000px] relative bg-black/100" >
        ...
        <div className="relative h-screen w-full z-20 p-35 pl-50 flex flex-col  gap-5">
          <div className="text-BrightWritingColor bg-white/8 mr-auto text-[12px] font-medium font- p-2 py-1 rounded-full border border-white/20">Rustic • Bold • Fiery <span className="text-orange-500">•</span> Non-veg curries</div>
      ...
      {/* <img src="/muttonCurryPhoto3.png" alt="" className="h-[100vh] w-full object-cover opacity-[52%]" /> */}

      <div
        className="absolute bottom-0 left-0 w-full h-55 bg-gradient-to-t from-black via-black/60 to-black/0  pointer-events-none z-20"
      ></div>
    </>
  )
}
