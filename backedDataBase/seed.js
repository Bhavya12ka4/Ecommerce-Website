...
// Define the Schema matches your EXACT data structure
const menuSchema = new mongoose.Schema({
    id: Number,
    name: String,        // Changed from 'title' to 'name' to match your data
    category: String,
    price: Number,       // Changed to Number so you can do math later
    description: String,
    image: String,
    spiceLevel: String,
    isVeg: Boolean
...
const seedDB = async () => {
    try {
        await Menu.deleteMany({}); // Warning: Deletes old data!
        await Menu.insertMany(menuData);
        console.log("✅ All 57 Menu Items Uploaded Successfully!");
    } catch (err) {
